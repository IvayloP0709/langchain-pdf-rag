...
from src.config import build_connection_string
...
# Autogenerate support (`alembic revision --autogenerate`) has nothing to diff
# against until real models exist; point target_metadata at a Base.metadata
